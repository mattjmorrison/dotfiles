...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:foreground ,zenburn-orange :height 1.2))))
   `(org-level-2 ((t (:foreground ,zenburn-green+1 :height 1.1))))
   ...
   `(org-block-begin-line ((t (:underline ,zenburn-bg-1 :foreground ,zenburn-bg-1))))
   ;`(org-block-background ((t (:background ,zenburn-bg+1)))) ;; This will highlight the entire code block
                                                               ; background which I don't like at the moment
   `(org-block-end-line ((t (:overline ,zenburn-bg-1 :foreground ,zenburn-bg-1))))
   ;; Make the title a little bigger
   `(org-document-title ((t (:height 1.6 :foreground "#1e1e1e"))))
   `(org-document-info ((t (:height 1.3 :foreground "#1e1e1e"))))
   `(org-document-info-keyword ((t (:height 1.0 :foreground ,zenburn-bg-05))))
