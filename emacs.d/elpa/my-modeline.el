;-------------------------------------------------------------------------------
; Name:          my-modeline.el
; Purpose:       Sets a custom mode line at the bottom of each buffer
; Author:        Jarrod-ish
; Notes:         This is not really my work the source is https://github.com/milkypostman/powerline
;                I kept it with my files as I may modify it in the future
; Created:       12/11/2012
; Time-stamp:    <12-15-2012 18:03:33 (jrock)>
; Version Num:   0.1
;-------------------------------------------------------------------------------
...
(defun create-or-get-powerline-cache ()
  "Return a frame-local hash table that acts as a memoization
   cache for powerline. Create one if the frame doesn't have one yet."
...
(defun memoize-wrap-frame-local (func)
  "Return the memoized version of FUNC.  The memoization cache is frame-local."
